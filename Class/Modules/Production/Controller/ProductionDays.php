...
use App\Controller;
use App\Modules\Production\Model\ProductionDaysModel;
use App\Modules\Production\Model\ProductionModel;

class ProductionDays extends Controller {

    public function __construct() {
        $this->model = new ProductionDaysModel;
    ...
    public function __invoke($id) {
        ...
        $this->assign('days', $this->model->getProductionDays($id));
        $this->display('Production/ProductionDays');
    }
